...
const Landing = (props: Props) => {
    ...
    useEffect(() => {
        ...
        ScrollTrigger.create({
            ...
            start: "30% 30%", // Настройте стартовую позицию анимации
            end: "bottom center", // Настройте конечную позицию анимации
            scrub: true,
            animation: tl,
        });
    }, []);
            ...
            <Element name={Navigation.Landing}>
                <div className="relative bg-savva/30 lg:hidden">
                    <div className="clip-hero-bg-white relative h-screen bg-white sm:flex">
                        <div ref={blockRef2} className="clip-hero-bg-mobile absolute flex h-full w-full bg-bgSavva bg-cover bg-center bg-no-repeat"></div>
                    </div>
                ...
                <div className="hidden h-screen w-auto bg-savva/40 md:hidden lg:visible lg:flex">
                    <div className="clip-header-white relative flex w-2/5 bg-white bg-cover bg-center bg-no-repeat">
                        <div
                            ref={blockRef}
                            className="clip-header -z-0 flex w-full bg-savva/30 bg-bgSavva bg-cover bg-center bg-no-repeat"
                        ></div>
                    </div>
